...
class AbilityOptionsDisplayTest
    : public ::testing::TestWithParam<AbilityDisplayCase>
{
};

TEST_P(AbilityOptionsDisplayTest, DisplaysExpectedActivatableAbilities)
{
...
INSTANTIATE_TEST_SUITE_P(
    ActivatableCards, AbilityOptionsDisplayTest,
    ::testing::Values(
