...
namespace dandan::serialization
{
    ...
    //     }
    //
    //     if (const auto *withDamage = dynamic_cast<const WithDamage
    //     *>(ability))
    //     {
    ...
    //         std::transform(
    //             spellAbility->effects().begin(),
    //             spellAbility->effects().end(),
    ...
    //     }
    //
    //     throw std::runtime_error("Unknown ability type for JSON
    //     serialization");
    // }
    //
    // std::unique_ptr<abilities::IAbility> JsonFactory<
    ...
    //     {
    //         auto
    //         static_type{data.at("static_type").get<StaticAbility::Type>()};
    //
